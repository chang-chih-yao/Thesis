...
\SetTitle %
{多人混合實境體感互動遊戲架構設計} %
{Framework Design for Multiplayer Motion Sensing Game in Mixture Reality \\Thesis/Dissertation Template in LaTex}
...
\SetAdvisorNameA{胡敏君}{Min-Chun Hu}
...
\SetKeywords{Mixture Reality}{Motion Sensing}{HoloLens}
...
\SetAbstractChiKeywords{Mixture Reality}{Motion Sensing}{HoloLens}
\SetAbstractEngKeywords{Mixture Reality}{Motion Sensing}{HoloLens}
